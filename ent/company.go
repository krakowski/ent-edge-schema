...
func (e CompanyEdges) AddressOrErr() ([]*Address, error) {
	if e.loadedTypes[0] {
...
// was not loaded in eager-loading.
func (e CompanyEdges) CompanyAddressesOrErr() ([]*CompanyAddress, error) {
	if e.loadedTypes[1] {
...
// QueryAddress queries the "address" edge of the Company entity.
func (c *Company) QueryAddress() *AddressQuery {
	return NewCompanyClient(c.config).QueryAddress(c)
}

// QueryCompanyAddresses queries the "company_addresses" edge of the Company entity.
func (c *Company) QueryCompanyAddresses() *CompanyAddressQuery {
	return NewCompanyClient(c.config).QueryCompanyAddresses(c)
}
