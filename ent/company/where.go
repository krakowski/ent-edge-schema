...
func HasAddress() predicate.Company {
...
func HasAddressWith(preds ...predicate.Address) predicate.Company {
	return predicate.Company(func(s *sql.Selector) {
		step := newAddressStep()
...
func HasCompanyAddresses() predicate.Company {
	return predicate.Company(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
func HasCompanyAddressesWith(preds ...predicate.CompanyAddress) predicate.Company {
	return predicate.Company(func(s *sql.Selector) {
